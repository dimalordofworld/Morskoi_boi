...
// MFCSeaBattle.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCSeaBattleApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CMFCSeaBattleApp

CMFCSeaBattleApp::CMFCSeaBattleApp()
{
...
// Единственный объект CMFCSeaBattleApp

CMFCSeaBattleApp theApp;


// инициализация CMFCSeaBattleApp

BOOL CMFCSeaBattleApp::InitInstance()
{
